...
class MapSampleState extends State<MapSample> {
  ...
  MapClusterManager<Place> _initClusterManager() {
    return MapClusterManager<Place>(items, _updateMarkers,
  ...
  Future<Marker> Function(MapCluster<Place>) get _markerBuilder =>
      (cluster) async {
        return Marker(
